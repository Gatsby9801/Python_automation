...
import cv2
ANNOTATIONS_DIR_PREFIX = "sheet_annotation/"
...
def read_file(file_path):
    ...
    print("imgh",image_file_name)

    img_file = ANNOTATIONS_DIR_PREFIX+image_file_name
    img = cv2.imread(img_file)
    h, w ,_= img.shape

    f_path = ANNOTATIONS_DIR_PREFIX+file_path
